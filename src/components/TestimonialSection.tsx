  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 border-b border-border">
      <div className="relative min-h-[400px]">
        <img
          src={getImageSrc("gallery1")}
          alt="Decorative"
          className="absolute inset-0 w-full h-full object-cover"
          style={{ opacity: getOpacity("gallery1") / 100 }}
          loading="lazy"
          width={640}
          height={800}
        />
      ...
      <div className="p-8 md:p-16 flex flex-col justify-center items-center text-center">
        <span className="text-xs tracking-[0.2em] font-body text-muted-foreground mb-6">{tr("highlights.label")}</span>
